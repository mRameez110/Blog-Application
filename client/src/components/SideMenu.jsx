...
const SideMenu = () => {
  return (
    <div className="px-4 h-max sticky top-8">
      <h1 className="mt-8 mb-8 text-sm font-medium">Search</h1>
      <h1 className="mt-8 mb-8 text-sm font-medium">Filter</h1>
      ...
      <h1 className="mt-8 mb-8 text-sm font-medium">Categories</h1>
      <div className="flex flex-col gap-2 text-sm">
