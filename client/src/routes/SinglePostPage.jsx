      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
            ...
            Consequuntur laboriosam adipisci illo unde facilis, quisquam
            inventore pariatur laudantium enim perferendis alias repudiandae
            nostrum obcaecati voluptatum excepturi sint? Molestias, ullam quas?
          </h1>
